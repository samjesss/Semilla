...
export default function ProfileResult() {
  ...
  return (
    <div className="min-h-screen semilla-canvas flex items-center justify-center p-4 overflow-hidden relative">
      ...
      <div className="max-w-xl w-full text-center space-y-8 animate-fade-in-up relative z-10">
        ...
        <Card className="p-6 md:p-8 space-y-5 relative overflow-hidden border-primary-100" variant="glass">
          ...
          <div className="bg-white/70 border border-primary-100 p-4 rounded-lg text-left space-y-2">
            ...
            <div className="flex flex-wrap gap-2">
              {profile.prioridades.map((prioridad, index) => {
                ...
                return (
                  <span
                    key={index}
                    className="text-xs font-bold text-ink bg-primary-50 border border-primary-100 px-3 py-1 rounded-md shadow-xs"
                  >
