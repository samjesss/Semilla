...
export default function OptionButton({
  ...
  return (
    ...
    >
      {/* Emoji / Icono */}
      {option.icono && (
        <span className="w-10 h-10 rounded-lg bg-accent-50 border border-accent-100 flex items-center justify-center text-xl mr-3 select-none" role="img" aria-label={option.texto}>
          {option.icono}
        </span>
      )}
      ...
      <div className={`ml-3 w-5 h-5 rounded-full border flex items-center justify-center ${
